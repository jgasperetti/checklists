...
\newcommand{\clitem}[2]{\item#1 \dotfill \textbf{\uppercase{#2}}}
...
\newcommand{\electricalheading}[1]{\columnheading{yellow!60!orange}{#1}}
...
\newcommand{\splititem}[2]{#1 \dotfill \textbf{#2}}
